--[[
    ...
    Represents different power ups that spawn at random from the top
    of the screen. When the player hits a power up with their paddle, they
    will get different benefits and the power up will disappear.
    layout of bricks.
]]
